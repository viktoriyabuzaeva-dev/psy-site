    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Консультации проходят в Zoom, длительность 55 минут. Вам понадобится стабильный интернет, компьютер или смартфон с камерой и микрофоном.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Стоимость одной консультации: 2500 рублей за 55 минут. Выбираете время в виджете на сайте, оплачиваете онлайн. Ссылка на Zoom приходит автоматически.',
        },
      },
      {
        '@type': 'Question',
